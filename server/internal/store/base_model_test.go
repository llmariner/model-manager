...
func TestBaseModel(t *testing.T) {
	...
	_, err = st.CreateBaseModel(modelID, "path", v1.ModelFormat_MODEL_FORMAT_GGUF, "gguf_model_path", tenantID)
...
func TestBaseModel_UniqueConstraint(t *testing.T) {
	...
	_, err := st.CreateBaseModel("m0", "path", v1.ModelFormat_MODEL_FORMAT_GGUF, "gguf_model_path", "t0")
	assert.NoError(t, err)
	...
	_, err = st.CreateBaseModel("m1", "path", v1.ModelFormat_MODEL_FORMAT_GGUF, "gguf_model_path", "t0")
	assert.NoError(t, err)
